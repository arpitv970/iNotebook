...
// ROUTE 3: Update the existing notes using: PUT "/api/auth/updatenote". Login required
...
// ROUTE 4: Delete the existing notes using: DELETE "/api/auth/deletenote". Login required
